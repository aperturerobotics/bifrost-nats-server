...
func (s *Server) AcceptLoop(clr chan struct{}) {
	...
	s.Noticef("Listening for client connections on internal mux mux")
...
// HandleClientConnection handles an incoming client session.
func (s *Server) HandleClientConnection(conn net.Conn) *client {
	return s.createClient(conn)
}
